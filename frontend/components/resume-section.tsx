...
export function ResumeSection({ data = resumeData, dictionary }: ResumeSectionProps) {
  ...
  return (
    <div className="space-y-8 md:space-y-10">
      ...
      {hasEducation && (
        <div>
          <div className="flex items-center gap-2 md:gap-3 mb-6">
            ...
            <h3 className="text-xl md:text-2xl font-bold text-foreground">{dictionary.education}</h3>
          </div>
      ...
      {hasExperience && (
        <div>
          <div className="flex items-center gap-2 md:gap-3 mb-6">
            ...
            <h3 className="text-xl md:text-2xl font-bold text-foreground">{dictionary.experience}</h3>
          </div>
          <div className="space-y-4">
      ...
      {hasSkills && (
        <div>
          <h3 className="text-xl md:text-2xl font-bold text-foreground mb-6">{dictionary.skills}</h3>
